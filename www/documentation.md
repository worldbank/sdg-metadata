...
The SDG Metadata Translation pilot produced a series of [detailed papers](https://worldbank.github.io/sdg-metadata/pilot/documentation/) describing the purpose, development, results and evaluation of its protocol to generate Russian translations using computer-assisted translation methods. The protocol was intended to enable others to replicate the pilot for their own translation needs. 
